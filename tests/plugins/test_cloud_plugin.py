...
def get_mock_plugin(
    ...
    result = {
        ATTR_PLUGIN_MODULE: "tests._plugins.cloud_plugin_mock", 
        ATTR_CONFIG: {}
    }
...
async def test_cloud_plugin_provider_speek(hass: HomeAssistant, workflow_name, react_component):
    ...
    data = {
        ...
        ATTR_MEDIA_CONTENT_ID: f"This is a test without volume|{TTS_CLOUD_PROVIDER}|{TTS_DEFAULT_LANGUAGE}",
