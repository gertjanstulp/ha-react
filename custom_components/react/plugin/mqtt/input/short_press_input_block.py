...
from custom_components.react.plugin.mqtt.const import CONF_SHORT_PRESS_ACTION
...
class MqttShortPressInputBlock(MqttButtonInputBlock):
    def __init__(self, react: ReactBase) -> None:
        super().__init__(react, CONF_SHORT_PRESS_ACTION, REACT_ACTION_SHORT_PRESS, "short press")
