...
class InputApi(ApiBase):
    ...
    async def async_input_number_set(self, context: Context, entity_id: str, value: float, input_provider: str = None):
        ...
        try:
            ...
            provider = self.get_input_provider(input_provider)
            if provider:
    ...
    async def async_input_number_increase(self, context: Context, entity_id: str, increase: float, max: float = None, input_provider: str = None):
    ...
    async def async_input_number_decrease(self, context: Context, entity_id: str, decrease: float, min: float = None, input_provider: str = None):
    ...
    async def async_input_text_set(self, context: Context, entity_id: str, value: str, input_provider: str = None):
    ...
    async def async_input_boolean_turn_on(self, context: Context, entity_id: str, input_provider: str = None):
    ...
    async def async_input_boolean_turn_off(self, context: Context, entity_id: str, input_provider: str = None):
    ...
    async def async_input_boolean_toggle(self, context: Context, entity_id: str, input_provider: str = None):
    ...
    def get_input_provider(self, input_provider: str) -> InputProvider:
        input_provider = input_provider or self.config.input_provider or INPUT_GENERIC_PROVIDER
        result = self.plugin_api.get_provider(PROVIDER_TYPE_INPUT, input_provider)
        if not result:
            _LOGGER.error(f"Input plugin: Api - Input provider for '{input_provider}' not found")
            return None
        return result
